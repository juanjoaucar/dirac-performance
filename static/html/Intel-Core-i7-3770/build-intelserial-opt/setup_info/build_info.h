...
#define CONFIGURATION_TIME       "2025-11-18 01:12:53.821900+00:00"
...
#define FORTRAN_COMPILER_FLAGS   " -O3 -xHost -w -assume byterecl -g -traceback -DVAR_IFX -fiopenmp"
...
#define C_COMPILER_FLAGS         " -O3 -xHost -g -fiopenmp"
...
#define CXX_COMPILER_FLAGS       " -O3 -xHost -Wno-unknown-pragmas -fiopenmp"
