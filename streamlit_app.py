...
#st.write("Este visor permite explorar, visualizar y analizar los reportes generados por DIRAC.")
st.markdown("""
Este visor permite:

- Cargar reportes de **DIRAC**
- Visualizar secciones clave
- Navegar resultados de forma interactiva  
""")
